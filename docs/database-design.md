...
| `user_notification_preferences` | User channel preferences by notification type | `id`, `tenant_id`, `user_id`, `notification_type`, `channel`, `enabled`, `created_at`, `updated_at`                                                             | Unique per user/type/channel                  |
