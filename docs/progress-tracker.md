...
| ------------ | --------------------------------- | ------------------------------------- |
| M0           | 18 Done, 1 In Progress, 1 Ready   | ENG-LOOP-03 active; ENG-LOOP-04 ready |
| M1           | 18 Done                           | Complete                              |
| M2           | 21 Done                           | Complete                              |
| M3           | 19 Done                           | Complete                              |
| M4           | 15 Done                           | Complete                              |
...
- 2026-07-04: ENG-LOOP-03 moved to In Progress while wiring the dedicated security validation profile. Existing API security-sensitive tests were identified, but `pnpm --dir apps/api test:security` still failed discovery with the current Vitest filters; keep ENG-LOOP-03 open until `pnpm validate:security` and `pnpm validate:full` pass.
