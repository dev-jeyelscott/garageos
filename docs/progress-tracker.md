...
| ------------ | --------------------------------- | --------------------------------------------------------------------------------- |
| M0           | 38 Done, 1 In Progress, 4 Backlog | ENG-LOOP-19 done; ENG-LOOP-20 in progress; ENG-LOOP-21 through ENG-LOOP-24 queued |
| M1           | 18 Done                           | Complete                                                                          |
| M2           | 22 Done                           | Complete                                                                          |
| M3           | 19 Done                           | Complete                                                                          |
| M4           | 15 Done                           | Complete                                                                          |
...
- [ ] **In Progress** — ENG-LOOP-20 — Add PR body and branch automation
