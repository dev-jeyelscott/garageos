...
| ------------ | --------------------------------- | --------------------------------------------------------------- |
| M0           | 36 Done, 1 In Progress, 6 Backlog | ENG-LOOP-18 in progress; ENG-LOOP-19 through ENG-LOOP-24 queued |
| M1           | 18 Done                           | Complete                                                        |
| M2           | 22 Done                           | Complete                                                        |
| M3           | 19 Done                           | Complete                                                        |
| M4           | 15 Done                           | Complete                                                        |
...
- [ ] **In Progress** — ENG-LOOP-18 — Add task claiming and run ledger
