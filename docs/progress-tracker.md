...
| ------------ | --------------------------------- | ---------------------------------------------------------- |
| M0           | 33 Done, 1 In Progress, 9 Backlog | ENG-LOOP-15 active; ENG-LOOP-16 through ENG-LOOP-24 queued |
| M1           | 18 Done                           | Complete                                                   |
| M2           | 22 Done                           | Complete                                                   |
| M3           | 19 Done                           | Complete                                                   |
| M4           | 15 Done                           | Complete                                                   |
...
- [ ] **In Progress** — ENG-LOOP-15 — Define automatic engineering-loop contract
