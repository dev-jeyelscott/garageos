...
export interface AuthAccessTokenPayload {
  readonly token_type: AuthTokenType;
  readonly sub: string;
...
export interface AuthRefreshSessionContract {
  readonly id: string;
  readonly user_id: string;
  readonly tenant_id: string | null;
  ...
  readonly revoked_reason: AuthRefreshSessionRevocationReason | null;
}
...
export interface AuthEffectivePlanLimits {
  ...
  readonly [capability_code: string]: boolean | number | string | null;
}
